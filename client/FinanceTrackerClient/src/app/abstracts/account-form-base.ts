...
@Directive() 
export abstract class AccountFormBase implements OnInit {
  protected static readonly CREATE_ACCOUNT_NAME: string = 'CreateAccount';
  ...
  onSubmit(): void {
    if (this.accountForm.valid) {
      ...
      if (this.getName() == AccountFormBase.CREATE_ACCOUNT_NAME) {
        ...
        this.accountService.createAccount(request).subscribe(observable);
      }
    } else {
